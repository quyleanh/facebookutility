...
app_id = "870942169712858"
app_secret = "395d9a741babf472a80e4bf6493d4070" # DO NOT SHARE WITH ANYONE!
file_id = "HogwartsVietnam"
...
def processFacebookComment(comment, status_id, parent_id = ''):
    ...
    #         unicode_normalize(comment['message']).decode('utf-8')
    comment_message = '' if 'message' not in comment else \
    ...
    return (comment_id, status_id, parent_id, comment_message.decode('utf-8'), comment_author.decode('utf-8'),
...
def scrapeFacebookPageFeedComments(page_id, access_token):
    with open('%s_facebook_comments.csv' % file_id, 'w', newline='', encoding='utf-8') as file:
        ...
        with open('%s_facebook_statuses.csv' % file_id, 'r', encoding='utf-8') as csvfile:
            ...
            reader = [dict(status_id='167994586682731_762868747195309')]
